...
const strings = new LocalizedStrings({
  de: {
    ...
    COVER: 'Buchen Sie noch heute Ihr Fahrzeug!',
    SUPPLIERS_TITLE: 'Wir verbinden Sie mit den größten Marken',
    MAP_TITLE: 'Karte der Mietstationen',
    MAP_PICK_UP_SELECTED: 'Abholort ausgewählt',
    MAP_DROP_OFF_SELECTED: 'Rückgabeort ausgewählt',
    DESTINATIONS_TITLE: 'Nach Zielen suchen',
    CAR_SIZE_TITLE: 'Unsere Fahrzeugklassen',
    CAR_SIZE_TEXT: 'Unsere Fahrzeuge gibt es in drei Hauptgrößen.',
    MINI: 'MINI',
    MIDI: 'MIDI',
    MAXI: 'MAXI',
    SEARCH_FOR_CAR: 'Fahrzeug suchen',

    TITLE: 'Top-Angebote für Mietwagen',
    SUBTITLE: 'Vergleichen Sie unsere Preise und buchen Sie noch heute!',
    WHY_TITLE: 'Buchen Sie noch heute und fahren Sie mit gutem Gefühl!',
    ...
    WHY_CHARGES: 'Was Sie sehen, ist der Preis, den Sie zahlen.',
    WHY_FLEET_TITLE: 'Vielseitige Flotte',
    WHY_FLEET: 'Wählen Sie aus einer großen Auswahl hochwertiger und zuverlässiger Fahrzeuge.',
    WHY_MILEAGE_TITLE: 'Unbegrenzte Kilometer',
    WHY_MILEAGE: 'Entdecken Sie Städte und Umgebung ohne Limit.',
    WHY_MILEAGE_ASTERISK: '*sofern angegeben',
    SERVICES_TITLE: 'Was uns auszeichnet',
    SERVICES_FLEET_TITLE: 'Große Fahrzeugauswahl',
    SERVICES_FLEET: 'Vom kompakten Stadtauto bis zum Premium-SUV – unsere Flotte deckt jeden Reisebedarf ab. Ob geschäftlich oder privat: Wir haben das passende Fahrzeug für Ihre Fahrt.',
    SERVICES_FLEXIBLE_TITLE: 'Flexible Abholung und Rückgabe',
    SERVICES_FLEXIBLE: 'Mit gut erreichbaren Stationen und flexiblen Zeiten machen wir die Anmietung unkompliziert. Ob Sie in der Stadt oder am internationalen Flughafen ankommen – Ihr Fahrzeug steht bereit.',
    SERVICES_PRICES_TITLE: 'Faire Preise',
    SERVICES_PRICES: 'Wir bieten wettbewerbsfähige Preise für alle Fahrzeuge, damit Sie hochwertige Autos zu attraktiven Konditionen erhalten. Sie müssen keine Kompromisse eingehen.',
    SERVICES_BOOKING_ONLINE_TITLE: 'Einfache Online-Buchung',
    SERVICES_BOOKING_ONLINE: 'Buchen Sie Ihren Mietwagen in wenigen Minuten über unsere benutzerfreundliche Online-Plattform. Optionen vergleichen, Anmietung anpassen und Fahrzeug bequem sichern.',
    SERVICE_INSTANT_BOOKING_TITLE: 'Sofortbuchung',
    SERVICE_INSTANT_BOOKING: 'Kein Warten! Sobald Sie Ihr Fahrzeug gewählt und die Buchung abgeschlossen haben, erhalten Sie eine sofortige Bestätigung – für einen reibungslosen Ablauf.',
    SERVICES_SUPPORT_TITLE: 'Kundenservice rund um die Uhr',
    SERVICES_SUPPORT: 'Ob bei der Buchung, unterwegs oder bei Fragen: Unser engagiertes Support-Team ist rund um die Uhr für Sie da.',
    CUSTOMER_CARE_TITLE: `${env.WEBSITE_NAME} Kundenservice`,
    CONTACT_US: 'Kontakt aufnehmen',
    CUSTOMER_CARE_SUBTITLE: 'Immer für Sie da',
    CUSTOMER_CARE_TEXT: `Bei ${env.WEBSITE_NAME} unterstützen wir Sie schnell und zuverlässig, damit Ihre Anmietung von Anfang bis Ende reibungslos und angenehm verläuft.`,
    CUSTOMER_CARE_ASSISTANCE: 'Pannenhilfe rund um die Uhr',
