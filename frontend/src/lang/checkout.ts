...
const strings = new LocalizedStrings({
  de: {
    ...
    PRICE_FOR: 'Preis für',
    DAY: 'Tag',
    PICK_UP_CHECKLIST_TITLE: 'Ihre Checkliste für die Abholung',
    PICK_UP_CHECKLIST_ARRIVE_ON_TIME_TITLE: 'Pünktlich erscheinen',
    PICK_UP_CHECKLIST_ARRIVE_ON_TIME_CONTENT: 'Die Fahrzeuge werden nur zur vereinbarten Abholzeit übergeben. In der Regel wird Ihr Fahrzeug nur für kurze Zeit nach dem vereinbarten Termin reserviert – danach kann es an andere Kundinnen und Kunden vergeben werden.',
    PICK_UP_CHECKLIST_DOCUMENTS_TITLE: 'Das brauchen Sie',
    PICK_UP_CHECKLIST_DOCUMENTS_CONTENT: 'Bei der Abholung benötigen Sie einen Personalausweis oder Reisepass sowie einen gültigen Führerschein.',
  },
  fr: {
    ...
    BOOK: 'Réserver avec obligation de paiement',
  ...
  en: {
    ...
    BOOK: 'Book with obligation to pay',
    SIGN_IN: 'Sign in?',
  ...
  es: {
    ...
    BOOK: 'Reservar con obligación de pago',
