...
const strings = new LocalizedStrings({
  de: {
    ...
    FORM_ERROR: 'Bitte korrigieren Sie die Fehler.',
    ALL: 'Alle',
    SUPPLIER: 'Anbieter',
    STATUS: 'Status',
    ...
    MIN_RENTAL_DAYS: 'Mindestmietdauer in Tagen',
    DRIVER_LICENSE: 'Führerschein',
    UPLOAD_DRIVER_LICENSE: 'Führerschein hochladen...',
    PRICE_CHANGE_RATE: 'Preisanpassung (+/- %)',
    SUPPLIER_CAR_LIMIT: 'Max. Fahrzeuge in der Suche',
    NOTIFY_ADMIN_ON_NEW_CAR: 'Administrator über neues Fahrzeug benachrichtigen',
    BLACKLISTED: 'Gesperrt',
    BLACKLISTED_TOOLTIP: 'Gesperrte Benutzer haben keinen Zugriff mehr auf die Plattform.',
    FIELD_NOT_VALID: 'Bitte halten Sie das erforderliche Format ein',
    INVOICE_ADDRESS: 'Rechnungsanschrift',
    INVOICE_ADDRESS_INFO: 'Pflichtangabe, wenn Rechnungen vom Anbieter ausgestellt werden.',
    VAT_ID: 'USt-IdNr.',
  ...
  fr: {
    ...
    INVOICE_ADDRESS_INFO: 'Obligatoire lorsque les factures sont émises par le fournisseur.',
    VAT_ID: 'N° de TVA',
  ...
  en: {
    ...
    INVOICE_ADDRESS_INFO: 'Required when invoices are issued by the supplier.',
    VAT_ID: 'VAT ID',
  ...
  es: {
    ...
    INVOICE_ADDRESS_INFO: 'Obligatorio cuando las facturas las emite el proveedor.',
    VAT_ID: 'NIF-IVA',
