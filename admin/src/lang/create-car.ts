...
const strings = new LocalizedStrings({
  de: {
    NEW_CAR_HEADING: 'Neues Fahrzeug',
    NAME: 'Name',
    LICENSE_PLATE: 'Kennzeichen',
    LICENSE_PLATE_ALREADY_EXISTS: 'Dieses Kennzeichen ist bereits vorhanden.',
    CAR_IMAGE_SIZE_ERROR: `Das Bild muss das Format ${env.CAR_IMAGE_WIDTH}x${env.CAR_IMAGE_HEIGHT} haben`,
    RECOMMENDED_IMAGE_SIZE: `Empfohlene Bildgröße: ${env.CAR_IMAGE_WIDTH}x${env.CAR_IMAGE_HEIGHT}`,
    SUPPLIER: 'Anbieter',
    LOCATIONS: 'Abholorte',
    AVAILABLE: 'In Suchergebnissen gelistet',
    CAR_TYPE: 'Motor',
    DAILY_PRICE: 'Tagespreis',
    DISCOUNTED_DAILY_PRICE: 'Reduzierter Tagespreis',
    HOURLY_PRICE: 'Stundenpreis (1 Std.)',
    DISCOUNTED_HOURLY_PRICE: 'Reduzierter Stundenpreis (1 Std.)',
    BI_WEEKLY_PRICE: 'Preis für 3 Tage',
    DISCOUNTED_BI_WEEKLY_PRICE: 'Reduzierter Preis für 3 Tage',
    WEEKLY_PRICE: 'Wochenpreis',
    DISCOUNTED_WEEKLY_PRICE: 'Reduzierter Wochenpreis',
    MONTHLY_PRICE: 'Monatspreis',
    DISCOUNTED_MONThLY_PRICE: 'Reduzierter Monatspreis',
    SEATS: 'Sitzplätze',
    DOORS: 'Türen',
    GEARBOX: 'Getriebe',
    AIRCON: 'Klimaanlage',
    ...
    CAR_RANGE: 'Fahrzeugkategorie',
    MULTIMEDIA: 'Multimedia',
    RATING: 'Bewertung',
    CO2: 'CO2 (g/km)',
    COMING_SOON: 'Demnächst verfügbar',
    FULLY_BOOKED: 'Ausgebucht',
    IS_DATE_BASED_PRICE: 'Datumsabhängige Preise',
    DATE_BASED_PRICES: 'Datumsabhängige Preise',
    BLOCK_ON_PAY: 'Fahrzeug bei erfolgreicher Zahlung sperren',
  },
  fr: {
