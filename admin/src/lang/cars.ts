...
const strings = new LocalizedStrings({
  de: {
    NEW_CAR: 'Neues Fahrzeug',
    DELETE_CAR: 'Möchten Sie dieses Fahrzeug wirklich löschen?',
    ...
    FUEL_POLICY_LIKE_FOR_LIKE_TOOLTIP: 'Das Fahrzeug wird betankt übergeben und muss mit dem gleichen Füllstand zurückgegeben werden.',
    FUEL_POLICY_FREE_TANK_TOOLTIP: 'Im Preis ist eine volle Tankfüllung enthalten.',
    FUEL_POLICY_FULL_TO_FULL_TOOLTIP: 'Das Fahrzeug wird vollgetankt übergeben und muss vollgetankt zurückgegeben werden.',
    FUEL_POLICY_FULL_TO_EMPTY_TOOLTIP: 'Das Fahrzeug wird vollgetankt übergeben und kann mit leerem Tank zurückgegeben werden.',
    DIESEL_TOOLTIP: 'Dieses Fahrzeug hat einen Dieselmotor',
    GASOLINE_TOOLTIP: 'Dieses Fahrzeug hat einen Benzinmotor',
    ELECTRIC_TOOLTIP: 'Dieses Fahrzeug ist elektrisch',
    HYBRID_TOOLTIP: 'Dieses Fahrzeug ist ein Hybrid',
    PLUG_IN_HYBRID_TOOLTIP: 'Dieses Fahrzeug ist ein Plug-in-Hybrid',
    GEARBOX_MANUAL_TOOLTIP: 'Dieses Fahrzeug hat ein Schaltgetriebe',
    GEARBOX_AUTOMATIC_TOOLTIP: 'Dieses Fahrzeug hat ein Automatikgetriebe',
    SEATS_TOOLTIP_1: 'Dieses Fahrzeug hat ',
    SEATS_TOOLTIP_2: 'Sitzplätze',
    DOORS_TOOLTIP_1: 'Dieses Fahrzeug hat ',
    DOORS_TOOLTIP_2: 'Türen',
    AIRCON_TOOLTIP: 'Dieses Fahrzeug hat eine Klimaanlage',
    ...
    CANCELLATION_TOOLTIP: 'Die Buchung kann vor Mietbeginn storniert werden.',
    AMENDMENTS: 'Änderungen',
    AMENDMENTS_TOOLTIP: 'Die Buchung kann vor Mietbeginn geändert werden.',
    THEFT_PROTECTION: 'Diebstahlschutz',
    THEFT_PROTECTION_TOOLTIP: 'Die Anmietung kann einen Diebstahlschutz enthalten.',
    COLLISION_DAMAGE_WAVER: 'Haftungsbefreiung bei Kollisionsschäden',
    COLLISION_DAMAGE_WAVER_TOOLTIP: 'Die Anmietung kann eine Haftungsbefreiung bei Kollisionsschäden enthalten.',
    FULL_INSURANCE: 'Vollkaskoversicherung',
    FULL_INSURANCE_TOOLTIP: 'Die Anmietung kann eine Haftungsbefreiung bei Kollisionsschäden sowie einen Diebstahlschutz enthalten.',
    ADDITIONAL_DRIVER: 'Zusatzfahrer',
    INCLUDED: 'Inklusive',
    AVAILABLE: 'Verfügbar',
    UNAVAILABLE: 'Nicht verfügbar',
    CAR_AVAILABLE: 'In Suchergebnissen gelistet',
    CAR_AVAILABLE_TOOLTIP: 'Dieses Fahrzeug wird in den Suchergebnissen angezeigt.',
    CAR_UNAVAILABLE: 'Nicht in Suchergebnissen gelistet',
    CAR_UNAVAILABLE_TOOLTIP: 'Dieses Fahrzeug wird nicht in den Suchergebnissen angezeigt.',
    VIEW_CAR: 'Dieses Fahrzeug ansehen',
    EMPTY_LIST: 'Keine Fahrzeuge.',
    CANNOT_DELETE_CAR: 'Dieses Fahrzeug kann nicht gelöscht werden, da es mit Buchungen verknüpft ist. Sie können es jedoch bearbeiten und für die Anmietung sperren.',
    GEARBOX: 'Getriebe',
    ENGINE: 'Motor',
    DEPOSIT: 'Kaution bei Abholung',
    LESS_THAN_VALUE_1: `Weniger als ${isUS ? env.CURRENCY : ''}${env.DEPOSIT_FILTER_VALUE_1}${!isUS ? (` ${env.CURRENCY}`) : ''}`,
    LESS_THAN_VALUE_2: `Weniger als ${isUS ? env.CURRENCY : ''}${env.DEPOSIT_FILTER_VALUE_2}${!isUS ? (` ${env.CURRENCY}`) : ''}`,
    LESS_THAN_VALUE_3: `Weniger als ${isUS ? env.CURRENCY : ''}${env.DEPOSIT_FILTER_VALUE_3}${!isUS ? (` ${env.CURRENCY}`) : ''}`,
